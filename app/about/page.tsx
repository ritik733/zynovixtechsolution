    ...
    <main className="bg-white text-slate-900 dark:bg-[#050816] dark:text-white">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              return (
                <div
                  key={value.title}
                  className="group rounded-3xl border border-slate-200 bg-white/80 p-8 transition duration-300 hover:-translate-y-2 hover:border-cyan-500 dark:border-slate-800 dark:bg-slate-900/60"
                >
                  <div className="mb-4 inline-flex rounded-2xl bg-cyan-500/10 p-3">
                    <Icon className="h-6 w-6 text-cyan-400" />
                  </div>
                  <h3 className="mb-3 text-xl font-semibold text-slate-900 dark:text-white">{value.title}</h3>
                  <p className="text-slate-600 dark:text-slate-300">{value.text}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-slate-800 dark:bg-slate-900/60">
              <div className="flex items-center gap-3">
                <Rocket className="h-6 w-6 text-cyan-500 dark:text-cyan-400" />
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white">End‑to‑End Solutions</h3>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-slate-800 dark:bg-slate-900/60">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Global Perspective</h3>
              </div>
              <p className="mt-2 text-slate-600 dark:text-slate-300">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-slate-800 dark:bg-slate-900/60">
              <div className="flex items-center gap-3">
                <Code className="h-6 w-6 text-cyan-500 dark:text-cyan-400" />
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-slate-800 dark:bg-slate-900/60">
              <div className="flex items-center gap-3">
                <Award className="h-6 w-6 text-cyan-500 dark:text-cyan-400" />
      ...
      <section className="py-20 text-center">
        <div className="mx-auto max-w-3xl px-6">
          <h2 className="text-4xl font-bold text-slate-900 dark:text-white">Ready to Build Something Amazing?</h2>
