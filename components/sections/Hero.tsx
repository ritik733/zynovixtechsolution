      ...
      <div className="relative mx-auto max-w-screen-2xl px-4 sm:px-6 md:px-8 lg:px-12 pt-24 pb-14 sm:pt-32 sm:pb-20 md:py-24 lg:py-28">
        <div className="grid items-center gap-10 lg:gap-20 lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm text-cyan-300 mx-auto lg:mx-0 shadow-[0_0_15px_rgba(34,211,238,0.2)]">
              <Sparkles size={15} />
              Websites • Enterprise ERP • System Automation
            </div>

            <h1 className="mt-5 sm:mt-8 text-[28px] min-[380px]:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-[1.15] sm:leading-tight tracking-tight">
              Build Scalable
            ...
            <p className="mt-4 sm:mt-6 md:mt-8 max-w-xl text-sm sm:text-lg leading-relaxed sm:leading-8 text-slate-300 mx-auto lg:mx-0">
              We engineer high-performance websites, custom ERP software,
              tailored business solutions, and end-to-end system automations that
              streamline operations, cut overhead, and accelerate growth.
            </p>

            <div className="mt-7 sm:mt-10 flex flex-col min-[420px]:flex-row gap-3 sm:gap-4 justify-center lg:justify-start w-full sm:w-auto">
              <Link
                href="/contact"
            ...
            {/* Stats */}
            <div className="mt-10 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-6">
              {[
                ["50+", "Projects"],
                ["99.9%", "Reliability"],
                ["100+", "Workflows"],
          ...
          >
            <div className="relative h-[270px] w-[270px] min-[360px]:h-[300px] min-[360px]:w-[300px] min-[420px]:h-[340px] min-[420px]:w-[340px] sm:h-[440px] sm:w-[440px] md:h-[500px] md:w-[500px] lg:h-[560px] lg:w-[560px] max-w-full">
              ...
              <div className="pointer-events-none absolute inset-8 rounded-full border border-blue-500/20" />
              ...
              <div className="pointer-events-auto absolute inset-0">
                ...
                >
                  <TiltCard intensity={25}>
                    <div className="rounded-xl border border-cyan-500/40 bg-slate-900/85 p-2 sm:p-3 backdrop-blur-md shadow-[0_0_25px_rgba(34,211,238,0.25)]">
                      <Database className="mb-1 sm:mb-2 h-4 w-4 sm:h-5 sm:w-5 text-cyan-400" />
                ...
                >
                  <TiltCard intensity={25}>
                    <div className="rounded-xl border border-blue-500/40 bg-slate-900/85 p-2 sm:p-3 backdrop-blur-md shadow-[0_0_25px_rgba(59,130,246,0.25)]">
                ...
                {/* System Automation — bottom center */}
                <motion.div
                  animate={{ y: [0, -6, 0] }}
                  transition={{
                    duration: 3.5,
                ...
                >
                  <TiltCard intensity={25}>
                    <div className="rounded-xl border border-emerald-500/40 bg-slate-900/85 p-2 sm:p-3 backdrop-blur-md shadow-[0_0_25px_rgba(16,185,129,0.25)] text-center">
                      <Bot className="mb-1 sm:mb-2 h-4 w-4 sm:h-5 sm:w-5 text-emerald-400 mx-auto" />
                      <p className="text-[10px] sm:text-xs font-medium whitespace-nowrap text-emerald-200">
                        System Automation
                      </p>
                    </div>
                  </TiltCard>
                ...
                <div className="absolute -bottom-8 sm:-bottom-10 left-1/2 -translate-x-1/2 text-center pointer-events-none w-max max-w-full px-2">
                  <p className="text-xs sm:text-base font-semibold text-white flex items-center gap-1.5 sm:gap-2 justify-center">
                    ...
                    Modular ERP &amp; Automation Architecture
                  </p>
                  <p className="mt-0.5 text-[10px] sm:text-xs text-slate-400">
                    Real-time 3D Matrix • Scroll &amp; Mouse Reactive
                  </p>
                </div>
              </div>
            </div>
